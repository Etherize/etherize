...
function (_React$Component) {
  ...
  function HeavenlyInterface(props) {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee2() {
      var _this$state, openLawConfig, apiClient, progress, progressMessage, _ref6, _ref7, jwt, err, errorInForm, uploadParams, _this$uploadParamsHas, _this$uploadParamsHas2, validEmail, memberEmail, contractId;
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 14:
              apiClient.jwt = jwt;
              errorInForm = _this.tryExecuteTemplate();
              ...
              _this.MiscellaneousModal.current.SetTextAndTitle("Error", errorInForm);
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee4() {
      var _this$state2, openLawConfig, apiClient, progress, progressMessage, _ref10, _ref11, jwt, err, errorInForm, uploadParams, contractId;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              return _context4.abrupt("return", [false, errorInForm]);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__["default"])(HeavenlyInterface, [{
    ...
    key: "tryExecuteTemplate",
    value: function tryExecuteTemplate() {
      ...
      var missingInputs = openlaw__WEBPACK_IMPORTED_MODULE_13__["Openlaw"].getMissingInputs(validationResult); // const missingInput = Openlaw.hasMissingInputs(validationResult);

      if (missingInputs.length > 0) {
        console.log("missing inputs: " + missingInputs[0]);
        return "Please finish filling out the form first, we're missing your " + missingInputs[0];
      }
    ...
    value: function togglePaymentMethodModal() {
      var errorInForm = this.tryExecuteTemplate();

      if (errorInForm != null) {
        this.MiscellaneousModal.current.SetTextAndTitle("Error", errorInForm);
...
//# sourceMappingURL=create.js.9501850b24d0130783b1.hot-update.js.map