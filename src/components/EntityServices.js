                ...
                {/* Products/cards row*/}
                  ...
                  {/*Card 2 Front*/}
                    ...
                    <MDBCard cascade className={"text-center"}>
                      ...
                      <MDBCardBody cascade>
                           <MDBCardTitle> <div/> <p className="card-title h3">Design Entity</p><h6>from</h6> <div/> 💦 & 🧠</MDBCardTitle>

                        <MDBCardText>
                        </MDBCardText>
                          <p> our wizard🧙 generates documents for you & co-founders to review and, if the stars align, sign
                          </p>
                  ...
                  <MDBCol lg="4" className="mb-4">
                    <MDBCard cascade className={"text-center"}>
                        <MDBCardBody cascade>
                          ...
                          <h4><MDBBadge className="mr-2 mt-2 badge-info"> Any State</MDBBadge><MDBBadge className="mr-2 mt-2 badge-info">Any Crypto Network</MDBBadge><MDBBadge className="mr-2 mt-2 badge-info">Non-Profitor LLC</MDBBadge></h4>
                  ...
                  <MDBCol lg="4" className="mb-4">
                      ...
                      <MDBCard cascade className={"text-center"}>
                        ...
                        <MDBCardBody cascade>
                             <MDBCardTitle> <div/> <p className="card-title h3">Form Hybrid Entity</p>
                             <div/>
                          ...
                          <p> our team of machine elves🧚‍ will toil until your hybrid entity is formed and making its first steps on Earth</p>
<MDBBtn size="lg" href={"/draft"} className={"btn-secondary"}>
                                             Begin <MDBIcon icon="bolt" />
                                           </MDBBtn>
                  ...
                  <MDBCol lg="4" className="mb-4">
                    <MDBAnimation reveal type="fadeInUp">
                      <MDBCard cascade className={"text-center"}>
                        <MDBCardBody cascade>
                          <MDBCardText>
                            <li>manage your Hybrid Entity using your email or network address</li>
                          ...
                          <h4><MDBBadge className="mr-2 mt-2 badge-info"> Wyoming</MDBBadge><MDBBadge className="mr-2 mt-2 badge-info">Non-Profit or LLC</MDBBadge><MDBBadge className="mr-2 mt-2 badge-info">Any Crypto Network</MDBBadge></h4>
                        </MDBCardBody>
                      </MDBCard>
                    </MDBAnimation>
                  </MDBCol>
              ...
              <MDBCol lg="4" className="mb-4">
                  ...
                  <MDBCard cascade className={"text-center"}>
                    ...
                    <MDBCardBody cascade>
                         <MDBCardTitle> <div/> <p className="card-title h3">Form Legal Entity</p>
                         <div/>
                      ...
                      <p> form your new legal entity without having to sign a single piece of paper - you can add on blockchain components later</p>
    <MDBBtn size="lg" href={"/draft"} className={"btn-secondary"}>
                                         Begin <MDBIcon icon="bolt" />
                                       </MDBBtn>
                    ...
                    <MDBCol lg="4" className="mb-4">
                      <MDBAnimation reveal type="fadeInUp">
                        <MDBCard cascade className={"text-center"}>
                          <MDBCardBody cascade>
                            <MDBCardText>
                              <li>your EIN and Formation Certificate will be sent to your inbox</li>
                            ...
                            <h4><MDBBadge className="mr-2 mt-2 badge-info"> Wyoming</MDBBadge><MDBBadge className="mr-2 mt-2 badge-info">Non-Profit or LLC</MDBBadge></h4>
                          </MDBCardBody>
                        </MDBCard>
                      </MDBAnimation>
                    </MDBCol>
