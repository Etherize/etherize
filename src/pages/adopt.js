...
import { Grid, Button, Table, Accordion, Icon, Loader, Image, Sticky, Modal, Rail, Placeholder, Ref, Container, Divider, Segment, Header, Search } from 'semantic-ui-react';
                    ...
                    <Table.HeaderCell>Intended Use</Table.HeaderCell>
                      <Table.HeaderCell colSpan='1'>Country / State</Table.HeaderCell>
                            <Table.HeaderCell colSpan='1'>Included Assets</Table.HeaderCell>
                              <Table.HeaderCell colSpan='1'>Requested Donation</Table.HeaderCell>
