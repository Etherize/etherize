            ...
            <>
                ...
                <div className={"mainBackground"}>
                    ...
                    <MDBContainer className={"mt-5"}>
                        <MDBRow>
                            <QuestionCard title={"What is Etherize?"} text={<p>Etherize Entities LLC provides formation and consulting services for both conventional and decentralized organizations. Etherize is a collective of Entities manifesting the potential of self-sovereign technologies towards a techno-utopic timeline; where blockchains are used for planetary liberation rather than further entrenching inequalities.</p>}/>
                            <QuestionCard title={"What is a Hybrid Entity?"} text={<p>A Hybrid Entity is an organization that has both a legal entity, such as an LLC, as well as decentralized component, such as a crypto-token. Crypto signatures can be used to signal Member voting; making an immutable and legallly binding record. While the Hybrids in existence are at present time infants, we are confident that Hybrids will usurp entrenched corporations that do not heed the winds of change.</p>}/>
                            ...
                            <QuestionCard title={"What do you mean by 'ethereal'?"} text={<p>Relating to, or similar to, Ethereum. Synonymous with 'decentralized'. An 'ethereal' component may run on the Ethereum network or any number of distributed ledgers similarly capable of computation. An 'ethereal' component, such as a DAO, is both physical and non-physical, much like the concept of ether in metaphysics.</p>}/>
                            ...
                            <QuestionCard title={"What is with the Portal?"} text={<p>The Portal is a metaphor for Wyoming's pro-crypto legislation, which has opened the possibility for Hybrid Entities to incarnate here on Earth with more material certainty than previously possible.</p>}/>
                            <QuestionCard id={Constants.ownershipFAQTag} title={"What is a Proof-of-Ownership crypto-token?"} text={<p>Your token can be used to prove that you own a legal entity without revealing your human identity. Your 'public key' can store a limitless number of tokens, which can be examined by anyone on a "block explorer" site such as <a href={"https://www.etherscan.io"}>etherscan</a>.</p>}/>
